                    ...
                    <tbody>
                        @foreach($order->childOrders()->where('split_status', 'split_child')->get() as $child)
                            <tr>
                                ...
                                <td>{{ currency_bdt($child->payable_total) }}</td>
                            ...
                            <tbody>
                                @foreach ($order->items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->quantity }}</td>
                                        <td class="order-item-price">tk.{{ number_format($item->unit_price, 2) }}</td>
                                        <td>
                                        ...
                                        <td class="order-item-price">tk.{{ number_format($item->total_price, 2) }}</td>
                                    </tr>
                                @endforeach
                                <tr class="order-total-row">
                                    <td colspan="4" style="text-align: right;">Subtotal</td>
                                    <td>tk.{{ number_format($order->items->sum('total_price'), 2) }}</td>
                                </tr>
