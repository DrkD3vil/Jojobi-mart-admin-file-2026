            ...
            <div class="form-card glass-effect animate-pop-in">
                ...
                <div class="form-section">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" class="form-input" name="name" required placeholder="Enter brand name"
                            value="{{ old('name') }}">
                ...
                <div class="form-section">
                    ...
                    <div class="textarea-wrapper">
                        ...
                        <textarea class="form-textarea" name="description" placeholder="Brief description about the brand..." rows="3">{{ old('description') }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="upload-container">
                        <div class="upload-area" id="uploadArea">
                            <input type="file" class="upload-input" name="logo" id="logoUpload" accept="image/*">
                            <div class="upload-content">
                                ...
                                <div class="upload-text">
                                    <h4 class="upload-title">Upload Logo</h4>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (logoUpload && uploadArea && logoPreview) {
                ...
                <button type="button" class="preview-remove" title="Remove logo">
                    <svg viewBox="0 0 24 24">
