                            ...
                            <tbody>
                                @foreach($order->items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->quantity }}</td>
                                        <td><strong>BDT {{ number_format($item->total_price, 2) }}</strong></td>
                                    </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td><strong>BDT {{ number_format($order->subtotal, 2) }}</strong></td>
                                </tr>
                                @if($order->discount_total > 0)
                                    <tr>
                                        <td colspan="4" class="text-right"><span style="color: #10B981;">Discount:</span></td>
                                        <td><span style="color: #10B981;">- BDT {{ number_format($order->discount_total, 2) }}</span></td>
                                    </tr>
                                @endif
                                @if($order->rewards_amount_used > 0)
                                    <tr>
                                        <td colspan="4" class="text-right"><span style="color: #8B5CF6;">Rewards Used:</span></td>
                                        <td><span style="color: #8B5CF6;">- BDT {{ number_format($order->rewards_amount_used, 2) }}</span></td>
                                    </tr>
                                @endif
                                <tr class="total-row">
                                    <td colspan="4" class="text-right"><strong>Total Payable:</strong></td>
                                    <td><strong class="total-amount">BDT {{ number_format($order->payable_total, 2) }}</strong></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
