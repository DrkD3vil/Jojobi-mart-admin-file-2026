                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            @forelse($images as $img)
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('storage/' . $img->image_path) }}" alt="Image not found"
                                    ...
                                    <td>
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            @else
                                                <button class="btn btn-sm btn-outline-secondary" disabled>🖼️
                                                    Manage</button>
                                            @endif
                                            ...
                                            @if ($p)
                                                <form method="POST"
                                                    action="{{ route('products.images.primary', [$p->id, $img->id]) }}">
                                                    @csrf
                                            ...
                                            <form method="POST"
                                                action="{{ route('product-images.deleteById', $img->id) }}">
                                                @csrf
                                                @method('DELETE')
